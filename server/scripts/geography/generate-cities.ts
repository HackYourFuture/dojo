...
const main = async () => {
  const URL =
    'https://public.opendatasoft.com/api/explore/v2.1/catalog/datasets/geonames-all-cities-with-a-population-1000/exports/json?lang=en&refine=cou_name_en%3A%22Netherlands%22&facet=facet(name%3D%22cou_name_en%22%2C%20disjunctive%3Dtrue)&qv1=(netherl)&timezone=Europe%2FBerlin';
